        ...
        with open(url_file_path, 'r') as f:
            ...
            for id, url in enumerate(reading_file, start=group_id):
                try:
                    ...
                    final_path = file_path[0]+f"-users_portfolio_groups."+file_path[-1]
                    data = {
                        "group_id": group_id,
                        "user_id": "",
...
th1 = Thread(target=handle_threading, args=(1, 5070295, r"C:\Users\anwaa\Downloads\Expida_AGAIN_LINKS.csv", 'D:/ExpediaGroup_6.csv'))
th1.start()
# time.sleep(15)
